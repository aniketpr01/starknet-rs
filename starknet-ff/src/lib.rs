...
impl FieldElement {
    ...
    pub const ZERO: Self = Self::from_mont([0, 0, 0, 0]);

    /// [`FieldElement`] constant that's equal to 1
    pub const ONE: Self = Self::from_mont([
    ...
    pub const TWO: Self = Self::from_mont([
    ...
    pub const THREE: Self = Self::from_mont([
    ...
    pub const MAX: Self = Self::from_mont([32, 0, 0, 544]);
...
impl AsRef<Self> for FieldElement {
    fn as_ref(&self) -> &Self {
        self
    }
}

impl ops::Add<Self> for FieldElement {
    type Output = Self;
...
impl ops::AddAssign<Self> for FieldElement {
    fn add_assign(&mut self, rhs: Self) {
        self.inner = self.inner + rhs.inner;
    }
}

impl ops::Sub<Self> for FieldElement {
    type Output = Self;
...
impl ops::SubAssign<Self> for FieldElement {
...
impl ops::MulAssign<Self> for FieldElement {
...
impl ops::Rem<Self> for FieldElement {
    type Output = Self;
...
impl ops::BitAnd<Self> for FieldElement {
    type Output = Self;
...
impl ops::BitOr<Self> for FieldElement {
    type Output = Self;
...
impl TryFrom<FieldElement> for u8 {
    ...
    fn try_from(value: FieldElement) -> Result<Self, Self::Error> {
        ...
        if repr[0] > Self::MAX as u64 || repr[1] > 0 || repr[2] > 0 || repr[3] > 0 {
...
impl TryFrom<FieldElement> for u128 {
    ...
    fn try_from(value: FieldElement) -> Result<Self, Self::Error> {
        ...
        if repr[2] > 0 || repr[3] > 0 {
            ...
            Ok((repr[0] as Self) + (repr[1] as Self) * (u64::MAX as Self + 1))
        }
    }
}
